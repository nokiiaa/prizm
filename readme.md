...
- Graphics subsystem with possible VMware SVGA II acceleration, software implementation should be done first (currently opens access to the VBE framebuffer through gfx.sys, starting work on a graphics API)
